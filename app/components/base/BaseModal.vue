...
<template>
  <Teleport to="body">
    ...
    <div v-bind="$attrs" class="modal__dialog" role="dialog" aria-modal="true">
      <div class="modal__dialog-wrapper">
        <BaseButton v-if="showCloseButton" class="modal__close" variant="outline" square @click="emit('close')">
